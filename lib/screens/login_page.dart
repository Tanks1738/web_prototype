...
import 'package:web_prototype/services/AuthUtil.dart';
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: CircleAvatar(
                      ...
                      radius: 80.0,
                      backgroundImage: AssetImage('images/come_in.png'),
                    ),
                  ),
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                      ...
                      child: RaisedButton(
                        ...
                        onPressed: () {
                          if (_formKey.currentState.validate()) {
                            AuthUtil.signInUser(emailController.text,
