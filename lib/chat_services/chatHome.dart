      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage(
              "images/Guide.jpg",                                               ///Background image
            ),
            fit: BoxFit.fill,
          ),
        ),
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            new Material(
                ...
                color: Colors.yellow[700], //Open conversations background colour
                child: new MaterialButton(
                  ...
                  child: Text("Open conversations",
                      ...
                      style: style.copyWith(
                          color: Colors.white, //Open conversations text color
            ...
            new Material(
                elevation: 5.0,
                borderRadius: BorderRadius.circular(30.0),
                color: Colors.black, //Logout button background color
                child: new MaterialButton(
                  onPressed: () {
                    KommunicateFlutterPlugin.logout().then((value) {
                      print("Logout successful : " + value);
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => chat_Main_Page()));
                  ...
                  child: Text("Logout",
                      textAlign: TextAlign.center,
                      style: style.copyWith(
                          color: Colors.yellowAccent, //Logout button text colour
                          fontWeight: FontWeight.bold)),
                )
    ),
    ]
